...
const STRINGS = {
  en: {
    ...
    teamsWord: "teams",
    // join by link/code
    joinEventCta: "Join event with a link",
    joinTeamCta: "Join team with a link or code",
    joinPlaceholder: "Paste an invite link or enter a code",
    joinGo: "Join",
    joinEventPageTitle: "Join an event",
    joinEventPageSub:
      "Paste the invite link a host shared with you, or enter their code below.",
    eventCodeLabel: "Event code",
    eventCodePlaceholder: "e.g. https://quiznight.hu/e?code=AB3XY",
    findEvent: "Find event",
    eventNotFoundTitle: "We couldn't find that event.",
    eventNotFoundSub: "Double-check the link or code and try again.",
    joinExistingTeamsTitle: "Teams already registered for this event",
    joinThisTeam: "Join this team",
    registerNewTeamTitle: "Register a new team",
    registerNewTeamSub:
      "You'll be the captain — invite teammates once you're in.",
    registerTeamBtn: "Register team",
    yourNameLabel: "Your name",
    yourNamePlaceholder: "e.g. Legal Dexter",
    teamJoinedTitle: (team: string) => `You're in, ${team}! 🎉`,
    teamJoinedSub: (game: string) =>
      `Your team is registered for ${game}. Share the invite link to bring in teammates.`,
    joinedShort: "Joined ✓",
    joinTeamPageTitle: "Join a team",
    joinTeamPageSub:
      "Paste the invite link a teammate shared with you, or enter their code below.",
    teamCodeLabel: "Team code",
    teamCodePlaceholder: "e.g. https://quiznight.hu/join?team=AB3XY",
    findTeam: "Find team",
    teamNotFoundTitle: "We couldn't find that team.",
    teamNotFoundSub: "Double-check the link or code and try again.",
    partOfEvent: "Registered for",
    requestSentTitle: (team: string) => `Request sent to ${team}!`,
    requestSentSub:
      "The captain needs to approve you before you're an active member.",
    joinedTeamTitle: (team: string) => `You joined ${team}! 🎉`,
    joinedTeamSub: "See you at the next quiz night.",
    // guest join (no-account) demo flow
    demoGuestJoin: "Demo: guest join via QR link",
    guestFormEmailLabel: "Your email",
    guestFormEmailPlaceholder: "e.g. dexter@example.com",
    guestJoinCta: "Join team",
    guestSuccessTitle: (name: string) => `You're in, ${name}! 🎉`,
    guestSuccessSub: (team: string, game: string) =>
      `You joined ${team} for ${game}.`,
    guestAuthNudgeTitle: "Want to keep this for next time?",
    guestAuthNudgeSub:
      "Create a free account (optional) to save your points, badges, and team — or just play as a guest tonight.",
    guestCreateAccount: "Create account",
    guestLogIn: "Log in",
    guestNoThanks: "No thanks, just playing",
    guestSimulateAfter: "Demo: simulate after the game",
    guestReminderTitle: (name: string) => `Nice playing, ${name}! 🏁`,
    guestReminderSub:
      "The quiz night is over — create a free account to save your points, badges, and team for next time.",
    guestReminderCreateAccount: "Create my account",
    guestReminderMaybeLater: "Maybe later",
    guestMemberBadge: "Guest",
    signupSoonTitle: "Account creation — coming soon",
    loginSoonTitle: "Login — coming soon",
    authSoonSub:
      "This prototype doesn't wire up real accounts yet — but this is exactly where signing in would take you.",
    // leaderboard page
    lbTitle: "Leaderboard",
  ...
  hu: {
    ...
    teamsWord: "csapat",
    // join by link/code
    joinEventCta: "Csatlakozás eseményhez linkkel",
    joinTeamCta: "Csatlakozás csapathoz linkkel vagy kóddal",
    joinPlaceholder: "Illessz be egy meghívó linket, vagy írd be a kódot",
    joinGo: "Csatlakozás",
    joinEventPageTitle: "Csatlakozás egy eseményhez",
    joinEventPageSub:
      "Illessz be a szervezőtől kapott meghívó linket, vagy írd be a kódot alább.",
    eventCodeLabel: "Esemény kódja",
    eventCodePlaceholder: "pl. https://quiznight.hu/e?code=AB3XY",
    findEvent: "Esemény keresése",
    eventNotFoundTitle: "Nem találtuk az eseményt.",
    eventNotFoundSub: "Ellenőrizd a linket vagy a kódot, és próbáld újra.",
    joinExistingTeamsTitle: "Már regisztrált csapatok ehhez az eseményhez",
    joinThisTeam: "Csatlakozás a csapathoz",
    registerNewTeamTitle: "Új csapat regisztrálása",
    registerNewTeamSub:
      "Te leszel a kapitány — a csatlakozás után hívhatod a csapattársaid.",
    registerTeamBtn: "Csapat regisztrálása",
    yourNameLabel: "A neved",
    yourNamePlaceholder: "pl. Legal Dexter",
    teamJoinedTitle: (team: string) => `Bent vagy, ${team}! 🎉`,
    teamJoinedSub: (game: string) =>
      `A csapatod regisztrálva erre: ${game}. Oszd meg a meghívó linket a csapattársaknak.`,
    joinedShort: "Csatlakoztál ✓",
    joinTeamPageTitle: "Csatlakozás egy csapathoz",
    joinTeamPageSub:
      "Illessz be egy csapattárstól kapott meghívó linket, vagy írd be a kódot alább.",
    teamCodeLabel: "Csapat kódja",
    teamCodePlaceholder: "pl. https://quiznight.hu/join?team=AB3XY",
    findTeam: "Csapat keresése",
    teamNotFoundTitle: "Nem találtuk a csapatot.",
    teamNotFoundSub: "Ellenőrizd a linket vagy a kódot, és próbáld újra.",
    partOfEvent: "Regisztrálva ide:",
    requestSentTitle: (team: string) => `Kérelem elküldve: ${team}!`,
    requestSentSub:
      "A kapitánynak jóvá kell hagynia, mielőtt aktív tag leszel.",
    joinedTeamTitle: (team: string) => `Csatlakoztál: ${team}! 🎉`,
    joinedTeamSub: "Találkozunk a következő kvízesten.",
    // guest join (no-account) demo flow
    demoGuestJoin: "Demó: vendégként csatlakozás QR-linkkel",
    guestFormEmailLabel: "E-mail címed",
    guestFormEmailPlaceholder: "pl. dexter@example.com",
    guestJoinCta: "Csatlakozás a csapathoz",
    guestSuccessTitle: (name: string) => `Bent vagy, ${name}! 🎉`,
    guestSuccessSub: (team: string, game: string) =>
      `Csatlakoztál ehhez: ${team}, ezen az eseményen: ${game}.`,
    guestAuthNudgeTitle: "Megtartanád ezt legközelebbre?",
    guestAuthNudgeSub:
      "Hozz létre egy ingyenes fiókot (nem kötelező), hogy megőrizd a pontjaid, jelvényeid és csapatod — vagy játssz most vendégként.",
    guestCreateAccount: "Fiók létrehozása",
    guestLogIn: "Bejelentkezés",
    guestNoThanks: "Köszi, most csak játszom",
    guestSimulateAfter: "Demó: szimuláld, hogy vége a játéknak",
    guestReminderTitle: (name: string) => `Jó volt játszani, ${name}! 🏁`,
    guestReminderSub:
      "Vége a kvízestnek — hozz létre egy ingyenes fiókot, hogy megőrizd a pontjaid, jelvényeid és csapatod legközelebbre.",
    guestReminderCreateAccount: "Fiók létrehozása",
    guestReminderMaybeLater: "Talán később",
    guestMemberBadge: "Vendég",
    signupSoonTitle: "Fiók létrehozása — hamarosan",
    loginSoonTitle: "Bejelentkezés — hamarosan",
    authSoonSub:
      "Ez a prototípus még nem köti össze a valódi fiókokat — de pontosan ide kerülnél, ha bejelentkeznél.",
    // leaderboard page
    lbTitle: "Ranglista",
